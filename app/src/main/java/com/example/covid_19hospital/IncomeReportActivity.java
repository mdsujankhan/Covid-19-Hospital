...
public class IncomeReportActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void addHeaders() {
        TableLayout tl = findViewById(R.id.incomeTable);
    ...
    public void addData() {
        ...
        RequestQueue queue = Volley.newRequestQueue(IncomeReportActivity.this);
        String url = MainActivity.ipPort + "admin/homeAPI";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                TableRow tr = new TableRow(IncomeReportActivity.this);
                                tr.setLayoutParams(getLayoutParams());
                                tr.addView(getTextView(i, response.getJSONObject(i).get("doctorFee").toString() +" Tk.", Color.WHITE, Typeface.NORMAL, ContextCompat.getColor(IncomeReportActivity.this, R.color.purple_200)));
                                tr.addView(getTextView(i, response.getJSONObject(i).get("cavinRent").toString() +" Tk.", Color.WHITE, Typeface.NORMAL, ContextCompat.getColor(IncomeReportActivity.this, R.color.purple_200)));
                                tr.addView(getTextView(i, response.getJSONObject(i).get("pathologyBill").toString() +" Tk.", Color.WHITE, Typeface.NORMAL, ContextCompat.getColor(IncomeReportActivity.this, R.color.purple_500)));
                                tr.addView(getTextView(i, response.getJSONObject(i).get("covidTest").toString() +" Tk.", Color.WHITE, Typeface.NORMAL, ContextCompat.getColor(IncomeReportActivity.this, R.color.purple_500)));
                                tl.addView(tr, getTblLayoutParams());
            ...
            public void onErrorResponse(VolleyError error) {
                //Toast.makeText(IncomeReportActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
        queue.add(request);
    ...
    public void onClick(View view) {
        ...
        if (null != tv) {
            ...
            Intent i = new Intent(IncomeReportActivity.this, ApproveApplicationActivity.class);
